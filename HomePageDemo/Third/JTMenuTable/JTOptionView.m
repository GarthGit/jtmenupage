...
@interface JTOptionView ()<UITableViewDelegate,UITableViewDataSource>
    ...
    switch (indexPath.section) {
        case 0:{
            ...
            if ([self.delegate respondsToSelector:@selector(optionView:selectedIndex:selectdSection:)]) {
                ...
                [self.delegate optionView:self selectedIndex:indexPath.row selectdSection:indexPath.section];
...
- (void)setDataSource:(NSArray *)dataSource {
    ...
    if (self.rowHeigt) {
        self.tableViewHeight = (self.dataSource.count+1)*self.rowHeigt;
    }else {
